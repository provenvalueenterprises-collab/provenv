"use strict";(()=>{var e={};e.id=3288,e.ids=[3288],e.modules={145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},6249:(e,t)=>{Object.defineProperty(t,"l",{enumerable:!0,get:function(){return function e(t,r){return r in t?t[r]:"then"in t&&"function"==typeof t.then?t.then(t=>e(t,r)):"function"==typeof t&&"default"===r?t:void 0}}})},1592:(e,t,r)=>{r.r(t),r.d(t,{config:()=>l,default:()=>d,routeModule:()=>c});var a={};r.r(a),r.d(a,{default:()=>u});var n=r(1802),o=r(7153),s=r(6249),i=r(946);async function u(e,t){if("POST"!==e.method)return t.status(405).json({message:"Method not allowed"});if("Bearer proven-value-cron-2025-secure-key"!==e.headers.authorization)return t.status(401).json({message:"Unauthorized"});try{let e=new Date().toISOString().split("T")[0];console.log(`Starting daily deduction process for ${e}`);let{data:r,error:a}=await i.qS.graphql.request(`
