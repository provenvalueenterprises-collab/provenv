"use strict";(()=>{var e={};e.id=288,e.ids=[288],e.modules={8770:e=>{e.exports=require("@nhost/nhost-js")},145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},6249:(e,t)=>{Object.defineProperty(t,"l",{enumerable:!0,get:function(){return function e(t,r){return r in t?t[r]:"then"in t&&"function"==typeof t.then?t.then(t=>e(t,r)):"function"==typeof t&&"default"===r?t:void 0}}})},4447:(e,t,r)=>{r.r(t),r.d(t,{config:()=>l,default:()=>d,routeModule:()=>c});var a={};r.r(a),r.d(a,{default:()=>u});var n=r(1802),o=r(7153),s=r(6249),i=r(5985);async function u(e,t){if("POST"!==e.method)return t.status(405).json({message:"Method not allowed"});if(e.headers.authorization!==`Bearer ${process.env.CRON_SECRET_TOKEN}`)return t.status(401).json({message:"Unauthorized"});try{let e=new Date().toISOString().split("T")[0];console.log(`Starting daily deduction process for ${e}`);let{data:r,error:a}=await i.q.graphql.request(`
    ...
    `,{today:e});if(a)return console.error("Error fetching active thrifts:",a),t.status(500).json({message:"Database error",error:a});let n=[],o=0,s=0;for(let t of r.thrift_plans)try{let r=t.user_profile?.wallet_balance||0;if(r<t.daily_amount){await i.q.graphql.request(`
          ...
          `,{thriftPlanId:t.id,amount:t.daily_amount,date:e,reason:"Insufficient wallet balance"}),n.push({userId:t.user_id,email:t.user.email,status:"failed",reason:"Insufficient funds",amount:t.daily_amount,balance:r}),s++;continue}let{error:a}=await i.q.graphql.request(`
